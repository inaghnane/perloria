...
require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/retailsy/features/retailsy-slider.php';
...
if ( ! function_exists( 'ecommerce_comp_retailsy_frontpage_sections' ) ) :
	function ecommerce_comp_retailsy_frontpage_sections() {	
		require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/retailsy/sections/section-slider.php';
