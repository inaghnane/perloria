...
/*=========================================
	...
	$wp_customize->add_setting(
    	'slider_desc',
    	array(
	        'default'			=> __('Lorem, ipsum dolor sit amet consectetur adipisicing elit. Natus omnis laborum nulla aut eaque, quidem, atque eum at incidunt, nesciunt officiis  mollitia voluptas saepe quae neque? Optio dicta aliquid ipsa?','ecommerce-companion'),
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'retailsy_sanitize_html',
			'transport'         => $selective_refresh,
			'priority' => 2,
    ...
    $wp_customize->add_setting( 
    	'slider_bg_img' , 
    	array(
			// 'default' 			=> esc_url(ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/express-store/assets/images/homepage1/page-slider/slider.png'),
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'retailsy_sanitize_url',	
			'priority' => 10,
		) 
    ...
    $wp_customize->add_setting( 
    	'slider_product_img' , 
    	array(
			'default' 			=> esc_url(ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/express-store/assets/images/homepage1/page-slider/product.png'),
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'retailsy_sanitize_url',	
			'priority' => 11,
		) 
...
function retailsy_slider_section_partials( $wp_customize ){
	...
	$wp_customize->selective_refresh->add_partial( 'slider_desc', array(
		'selector'            => '.banner-text-section .banner-item-desc',
		'settings'            => 'slider_desc',
		'render_callback'  => 'retailsy_slider_desc_render_callback',
	) );
...
// slider_desc
function retailsy_slider_desc_render_callback() {
