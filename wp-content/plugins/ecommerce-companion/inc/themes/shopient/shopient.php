...
require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/shopient/theme-functions/extras.php';
...
require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/shopient/features/storely-slider.php';
...
if ( ! function_exists( 'ecommerce_comp_storely_frontpage_sections' ) ) :
	function ecommerce_comp_storely_frontpage_sections() {	
		require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/shopient/sections/section-slider.php';
		require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/shopient/sections/section-service.php';
