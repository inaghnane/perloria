				...
				<div class="container">
					<div class="row">
						<div class="col-12 d-flex flex-wrap align-items-center justify-content-center">
							<div class="banner-text-section text-center py-5 py-md-0">
								...
								<div class="d-flex gap-3 slide-text slider-btn align-items-center justify-content-center"
									>
									<?php if ( ! empty( $button ) ) : ?>
										<a href="<?php echo esc_url($link); ?>" <?php if($open_new_tab== 'yes' || $open_new_tab== '1') { echo "target='_blank'"; } ?> class="fl-btn3"><span><?php echo esc_html($button); ?></span></a>
									<?php endif; ?>
